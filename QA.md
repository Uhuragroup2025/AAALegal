...
| D-07 | La dirección teal y Space Grotesk de D22/D23 permanecen en la Home implementada, pero fueron reemplazadas como dirección futura por el Visual Language Lab aprobado en D26. La migración aún no se ha ejecutado y no debe confundirse el estado actual con la referencia interna. | N/A (transición de diseño, no defecto técnico) | No bloquea sincronización; sí debe resolverse antes de presentar la nueva dirección como aplicada | Product Lead / implementación visual | **Cerrado como decisión (2026-08-05); implementación pendiente** |
...
| D-10 | Los degradados atmosféricos y la iconografía Phosphor del Visual Language Lab siguen en refinamiento: los degradados deben mostrarse como fondos de sección, no como cards, y los iconos deben diferenciarse mediante peso, selección y uso contextual sin clichés jurídicos. No están aplicados en la Home. | N/A (refinamiento de la referencia interna) | No bloquea la sincronización; bloquea dar esos dos tratamientos por cerrados | Product Lead / diseño | Abierto |
